# Set of Bun packages to install
{
  ...
  "@types/react" = {
    ...
    name = "@types/react@19.1.14";
    url = "https://registry.npmjs.org/@types/react/-/react-19.1.14.tgz";
    hash = "sha512-ukd93VGzaNPMAUPy0gRDSC57UuQbnH9Kussp7HBjM06YFi9uZTFhOvMSO2OKqXm1rSgzOE+pVx1k1PYHGwlc8Q==";
  };
  "bun-types" = {
    out_path = "bun-types";
  ...
  "ky" = {
    ...
    hash = "sha512-YRPCzHEWZffbfvmRrfwa+5nwBHwZuYiTrfDX0wuhGBPV0pA/zCqcOq93MDssON/baIkpYbvehIX5aLpMxrRhaA==";
  };
  "merge-stream" = {
  ...
  "shumai" = {
    out_path = "shumai";
    name = "shumai@0.1.2";
    url = "https://registry.npmjs.org/shumai/-/shumai-0.1.2.tgz";
    hash = "sha512-iIopizh46hVmjh7TWfxfSaswktiwaGtiWQk+2+vjrM9HA1YJvQ3nixGUZWL2DoUDa/4LZWckCVTQCme9xem6FA==";
  };
  "signal-exit" = {
  ...
  "system-architecture" = {
    out_path = "system-architecture";
    name = "system-architecture@0.1.0";
